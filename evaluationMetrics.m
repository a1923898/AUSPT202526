...
fprintf('2. PESQ narrowband (Quality):      %.4f  (Range: 1-5)\n', results.PESQ(1));
fprintf('2. PESQ wideband (Quality):      %.4f  (Range: 1-5)\n', results.PESQ(2));
...
fprintf(fid, 'PESQ narrowband:  %.4f (1-5)\n', results.PESQ(1));
fprintf(fid, 'PESQ wideband:  %.4f (1-5)\n', results.PESQ(2));
